...
namespace RealTimeInventoryTracker.WPF.Helpers
{
    public static class TextBoxHelper
    {
        ...
        public class PlaceholderAdorner : Adorner
        {
            ...
            protected override void OnRender(DrawingContext drawingContext)
            {
                ...
                if (string.IsNullOrEmpty(placeholderValue) || !string.IsNullOrEmpty(_textBox.Text))
                    return;
                ...
                text.MaxTextWidth = System.Math.Max(textBoxControl.ActualWidth - textBoxControl.Padding.Left - 
                    textBoxControl.Padding.Right, 10);
